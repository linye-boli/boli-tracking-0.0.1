...
parser.add_argument('--inp_dim', dest='inp_dim', type=str, default='320',help='inpdim')
parser.add_argument('--outdir', dest='outputpath',default='/home/fudan/Desktop/zls/tracking_pj/tracking/result/webcam_output', help='output-directory')
...
parser.add_argument('--vis', default=False, help='visualize image')
...
parser.add_argument('--nms', dest='nms_thesh', type=float, default=0.1,
