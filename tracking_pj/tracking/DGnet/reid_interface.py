...
# set gpu ids
if len(gpu_ids) > 0:
    torch.cuda.set_device(gpu_ids[2])
...
def load_network(network):
    save_path = os.path.join('/home/fudan/Desktop/zls/tracking_pj/tracking-multi-thread/reid/outputs',name,'checkpoints/id_%08d.pt'%opt.which_epoch)
...
###load config###
config_path = os.path.join('/home/fudan/Desktop/zls/tracking_pj/tracking-multi-thread/reid/outputs',name,'config.yaml')
