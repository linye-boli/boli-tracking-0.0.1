...
import yaml
import cv2
sys.path.append('G:/pose-estimation/tracking/reid/')
...
def load_network(network):
    save_path = os.path.join('G:/pose-estimation/tracking/reid/outputs',name,'checkpoints/id_%08d.pt'%opt.which_epoch)
...
###load config###
config_path = os.path.join('G:/pose-estimation/tracking/reid/outputs',name,'config.yaml')
